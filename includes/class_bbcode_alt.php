...
*
* @package 		vBulletin
* @version		$Revision: 77118 $
* @date 		$Date: 2013-08-27 08:17:40 -0700 (Tue, 27 Aug 2013) $
*
*/
...
class vB_BbCodeParser_PlainText extends vB_BbCodeParser
{
	...
	* @param boolean $fullsize added for PHP 5.4 strict standards compliance
	*
	* @return	string	HTML representation of the tag.
	*/
...
class vB_BbCodeParser_Video_PreParse extends vB_BbCodeParser
{
	...
	*
	* @param string	 The text to search for an image in.
	* @param boolean $do_imgcode   added for PHP 5.4 strict standards compliance
	* @param boolean $has_img_code added for PHP 5.4 strict standards compliance
	* @param string  $fulltext     added for PHP 5.4 strict standards compliance
	*
	* @return	string	HTML representation of the tag.
	*/
	function handle_bbcode_img($bbcode, $do_imgcode = true, $has_img_code = false, $fulltext = '')
	{
		return $bbcode;
	}
	...
	* @return	string	Parsed text
	*/
	function parse($text, $forumid = 0, $allowsmilie = false, $isimgcheck = false, $parsedtext = '', $parsedhasimages = false, $cachable = false, $htmlstate = null)
	{
		return parent::parse($text, $forumid, $allowsmilie, $isimgcheck, $parsedtext, $parsedhasimages);
	}
