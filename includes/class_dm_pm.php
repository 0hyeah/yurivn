...
*
* @package	vBulletin
* @version	$Revision: 77260 $
* @date		$Date: 2013-09-02 17:15:46 -0700 (Mon, 02 Sep 2013) $
*/
class vB_DataManager_PM extends vB_DataManager
{
	...
	*/
	...
	/**
	 * 
	 * @param string $clause - Added for PHP 5.4 strict standards compliance
	 */
	public function set_condition($clause = '')
	{
