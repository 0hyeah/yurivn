...
class vB_Image
{
	...
	* @return	object
	*/
	static function &fetch_library(&$registry, $type = 'image')
	{
...
class vB_Image_Abstract
{
	...
	* @param 	bool	sharpen 	|	All these params followed by | were added to comply with PHP Strict Standards,
	* @param	int		owidth		|	if you know their purpose plase add their description
	* @param	int		oheight		|	
	* @param	int		ofilesize	|
	*
	* @return	array
