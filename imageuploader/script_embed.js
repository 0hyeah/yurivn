...
var options = {
	...
	format:		'direct',	//danh sách các link trả về đc format theo bbcode, html và link trực tiếp
...
function renderUploader() {
	var html = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="75" height="25"> \
		...
		<embed name="flashplayer" src="imageuploader/upload.swf" flashvars="'
...
function displaypic(name, url) {
	$("#result").append('<div><span class="name">'+name+'</span><input type="text" class="link" value="'+url+'" /></div>');
	showList();
}
