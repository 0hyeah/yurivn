...
edge=o.menupos=='right'? 0 : truebody().clientWidth? truebody().clientWidth : window.innerWidth&&truebody().offsetHeight<=window.innerHeight? window.innerWidth :  window.innerWidth? window.innerWidth-20 : 0;
...
move(el, Math.min(-1*m1-el.borderwidth, 100));
}
function moveout(el){
if(el.moving)
clearTimeout(el.moving);
...
if(!o.menuleft) {o.menuleft='30%'};
if(!o.keepinview&&typeof o.keepinview=='boolean')
o.keepinview=false;
else if(!o.keepinview) {o.keepinview=30};
if(!o.menuspeed) {o.menuspeed=1};
if(!o.menupause) {o.menupause=1};
if(!o.d_colspan) {o.d_colspan=3};
if(!o.allowtransparent) {o.allowtransparent=false};
if(!o.barwidth) {o.barwidth=1};
if(!o.hdingwidth) {o.hdingwidth=580};
if(!o.hdingheight) {o.hdingheight=22};
if(!o.hdingindent) {o.hdingindent=0};
if(!o.linkheight) {o.linkheight=25};
if(!o.outbrdwidth) {o.outbrdwidth=2};
if(!o.outbrdcolor) {o.outbrdcolor="#ffffff"};
if(!o.outbrdstyle) {o.outbrdstyle="#000000"};
if(!o.borderwidth) {o.borderwidth=0};
if(!o.bordercolor) {o.bordercolor="#ffffff"};
if(!o.borderstyle) {o.borderstyle="solid"};
if(!o.barcolor) {o.barcolor="#ffffff"};
if(!o.barbgcolor) {o.barbgcolor="#000000"};
if(!o.barfontweight) {o.barfontweight="bold"};
if(!o.baralign) {o.baralign="center"};
if(!o.menufont) {o.menufont="verdana"};
if(!o.fontsize) {o.fontsize="100%"};
if(!o.hdingcolor) {o.hdingcolor="#000000"};
if(!o.hdingbgcolor) {o.hdingbgcolor=" #f9c653"};
...
var tb='<div id="'+o.id+'" onclick="movein(this);" ondblclick="moveout(this);"><div><table>\n';
